...
if __name__ == '__main__':
    ...
    X, X_vocab_len, X_word_to_ix, X_ix_to_word, y, y_vocab_len, y_word_to_ix, y_ix_to_word = load_data('data/europarl-v8.fi-en/europarl-v8.fi-en.en', 'data/europarl-v8.fi-en/europarl-v8.fi-en.fi', MAX_LEN, VOCAB_SIZE)
